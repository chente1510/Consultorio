...
<div class="card p-4 bg-light">
  <form enctype="multipart/form-data" action="<?php print RUTA; ?>pacientes/alta/" method="POST">
    ...
    <div class="form-group text-left">
      ...
      placeholder="Escribe si el paciente cuenta con seguro social"
      value="<?php 
    ...
    <div class="form-group text-left">
      <label for="numCalzado">CURP:</label>
    ...
    <div class="form-group text-left">
      <label for="horma">Alergias:</label>
      <input type="text" name="horma" class="form-control" 
      placeholder="Escribe si el paciente es alergico a algun medicamento y escribe el o los medicamientos"
      value="<?php 
    ...
    <div class="form-group text-left">
      <label for="tacones">Número Alternativo:</label>
      <input type="text" name="tacones" class="form-control" 
      placeholder="Escribe un numero alternativo en caso de emergencia"
      value="<?php 
